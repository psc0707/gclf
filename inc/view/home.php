<section>
	...
	<br /><br />
	<form action="<?= __BASE_URL__ ?>index.php" method="get" id="homeSearch">
...
<section class="listeCategories">
	...
	<a href="<?= __BASE_URL__ ?>catalogue/?cat_id=<?php echo $curCategorieInfos['cat_id']; ?>"><?php echo $curCategorieInfos['cat_nom'].' ('.$curCategorieInfos['nb'].')'; ?></a>&nbsp; &nbsp;        
	<?php endforeach; ?>
</section>